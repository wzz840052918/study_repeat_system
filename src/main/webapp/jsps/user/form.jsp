          ...
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form action="${pageContext.request.contextPath}/repeat/submit" method="post" enctype="multipart/form-data">
                  <span style="color: #00A000">要查重的文件：</span><input class="form-control" type="file"  name="file1">
                  <span style="color: #942a25">对比文件：</span><input class="form-control" type="file" name="file2">
                  <button name="submit" type="submit" class="btn btn-success">对比</button>
                </form>
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 ">是否抄袭：</label>
                  <div class="col-md-9 col-sm-9 ">
                    <textarea class="resizable_textarea form-control" placeholder="这里显示重复率">${result}</textarea>
                  </div>
                </div>
              </div>
            </div>
