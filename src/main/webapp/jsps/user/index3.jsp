...
<html lang="en">
  ...
  <body class="nav-md">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tr class="headings">
                        ...
                        <th class="column-title">班级编号</th>
                        <th class="column-title">行政班级</th>
                        <th class="column-title">平时成绩总分</th>
                        <th class="column-title">平时成绩平均分</th>
                        <th class="column-title">期末试卷成绩总分</th>
                        <th class="column-title">期末试卷成绩平均分</th>
                        <th class="column-title">总成绩总分</th>
                        <th class="column-title">总成绩平均分</th>
                        ...
                        <button type="button" class="btn btn-round btn-success" onclick="addStudent()">添加数据</button>
                      </tr>
                      </thead>
                        ...
                        <c:choose>
                          <c:when test="${index == 0}">
                            <tr class="even pointer">
                              <td class="a-center ">
                                <input type="checkbox" class="flat" name="table_records" value="${publicclass.cid}">
                              </td>
                              <td class=" ">${publicclass.cid}</td>
                              <td class=" ">${publicclass.sclass} </td>
                              <td class=" ">${publicclass.sub_daily_score} <i
                                      class="success fa fa-long-arrow-up"></i></td>
                              <td class=" ">${publicclass.ave_daily_score}</td>
                              <td class=" ">${publicclass.sub_last_score}</td>
                              <td class=" ">${publicclass.ave_last_score}</td>
                              <td class=" ">${publicclass.sub_all_score}</td>
                              <td class=" ">${publicclass.ave_all_score}</td>
                              <td class="">
                                <%--<a href="${pageContext.request.contextPath}/tclass/editPublicInformation?cid=${cid}}">修改</a>|--%>
                                <a href="${pageContext.request.contextPath}/tclass/deletePublicInformation?cid=${cid}}">删除</a>
                              </td>
                            </tr>
    ...
    <script>
        function addStudent() {
            window.location.href = '${pageContext.request.contextPath}/student/aboutInformation?index=3'
        }
    </script>
    <!-- jQuery -->
