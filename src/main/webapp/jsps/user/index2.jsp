  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-round btn-success" onclick="addStudent()">成绩录入</button>
                  <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tr class="headings">
                        ...
                        <th class="column-title">课程名</th>
                        <th class="column-title">平时成绩</th>
                        <th class="column-title">期末试卷成绩</th>
                        <th class="column-title">总成绩</th>
                        ...
                        <c:choose>
                          <c:when test="${index == 0}">
                            <tr class="even pointer">
                              <td class=" ">${personal.sid}</td>
                              <td class=" ">${personal.sname} </td>
                              <td class=" ">${personal.ssex} </td>
                              <td class=" ">${personal.sclass}</td>
                              <td class=" ">${personal.lname}</td>
                              <td class=" ">${personal.daily_score}</td>
                              <td class=" ">${personal.last_score}</td>
                              <td class=" ">${personal.all_score}</td>
                              <td>
                                <a href="${pageContext.request.contextPath}/personal/edit?sid=${personal.sid}">修改</a>
                                <a onclick="shanchu(${personal.sid})">删除</a>
                              </td>
                            </tr>
        ...
        <!-- /page content -->
        <input type="text" id="msg" value="${msg}" hidden>
        <!-- footer content -->
        <footer>
    ...
    <script>
        function addStudent() {
            window.location.href = '${pageContext.request.contextPath}/personal/toAddScore'
        }
        function shanchu(sid) {
            if(confirm("确定要删除？")){
                window.location.href='${pageContext.request.contextPath}/personal/delete?sid='+sid
            }
        }
