                ...
                <div class="x_content">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      <%--学生信息form--%>
                      <c:if test="${index == 1}">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/student/addStudent" method="post">
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">学 号 <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="first-name" name="sid" required="required" class="form-control ">
                            </div>
                          </div>
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="last-name" name="sname" required="required" class="form-control">
                            </div>
                          </div>
                          <div class="item form-group">
                          ...
                          <div class="item form-group">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">所在院校</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="colleage">
                            </div>
                          </div>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">行政班级</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="sclass">
                            </div>
                          </div>
                          <div class="item form-group">
                        ...
                        <%--个人学习信息form--%>
                      <c:if test="${index == 2}">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/personal/toAddScore" method="post">
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">学 号 <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="daily_score">
                            </div>
                          </div>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">期末试卷成绩</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="last_score">
                            </div>
                          </div>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">总成绩</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="all_score">
                            </div>
                          </div>
                          <div class="ln_solid"></div>
                          <div class="item form-group">
                        ...
                        <%--班级学习信息form--%>
                      <c:if test="${index == 3}">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/tclass/addPublicInformation" method="post">
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">班级编号<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                              <select name="cid" class="form-control">
                                <option value="1801">18级Java1班</option>
                                <option value="1802">18级Java2班</option>
                                <option value="1803">18级Java3班</option>
                                <option value="1804">18级Java4班</option>
                              </select>
                            </div>
                          </div>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">平时成绩总分</label>
                            <input type="text" id="last-name" name="sub_daily_score" required="required" class="form-control">
                          </div>
                          <div class="item form-group">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">期末试卷成绩总分</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="sub_last_score">
                            </div>
                          </div>
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">总成绩总分</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control" type="text" name="sub_all_score">
                            </div>
                          </div>
                      ...
                      <div><p style="color: #942a25">${error}</p></div>
                    </table>
                  </div>
